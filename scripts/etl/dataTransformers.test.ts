...
describe('IngredientParser', () => {
  describe('parseIngredient', () => {
    ...
    it('should parse ingredient with unit abbreviation', () => {
      const result = IngredientParser.parseIngredient('1 c. firmly packed brown sugar');
    ...
    it('should identify optional ingredients', () => {
      const result = IngredientParser.parseIngredient('1/2 cup nuts (optional)');
...
describe('InstructionParser', () => {
  describe('parseInstruction', () => {
    ...
    it('should extract prep time from instruction', () => {
      const result = InstructionParser.parseInstruction('Chop vegetables (5 minutes)');
    ...
    it('should extract cook time from instruction', () => {
      const result = InstructionParser.parseInstruction('Bake for 30 minutes at 350°F');
    ...
    it('should extract temperature from instruction', () => {
      const result = InstructionParser.parseInstruction('Preheat oven to 400 degrees');
    ...
    it('should handle complex instructions with multiple time references', () => {
      const result = InstructionParser.parseInstruction('Marinate for 2 hours, then cook for 45 minutes at 375°F');
      
      expect(result.instruction).toBe('Marinate for 2 hours, then cook for 45 minutes at 375°F');
      expect(result.prep_time).toBeUndefined();
    ...
    it('should handle instructions with temperature in Celsius', () => {
      const result = InstructionParser.parseInstruction('Bake at 180°C for 25 minutes');
...
describe('RecipeAnalyzer', () => {
  describe('analyzeDifficulty', () => {
    it('should classify easy recipes', () => {
      ...
      const difficulty = RecipeAnalyzer.analyzeDifficulty(ingredients, directions);
      
      expect(difficulty).toBe('easy');
    });

    it('should classify medium recipes', () => {
      const ingredients = ['2 cups flour', '1 cup sugar', '2 eggs', '1 tsp vanilla', '1/2 cup butter'];
      const directions = [
        'Mix dry ingredients',
  ...
  describe('extractDietaryTags', () => {
    it('should identify vegetarian ingredients', () => {
      const ingredients = ['2 cups flour', '1 cup milk', '2 eggs', '1 cup cheese'];
  ...
  describe('estimateCookingTimes', () => {
    it('should estimate prep time from directions', () => {
      const directions = ['Chop vegetables (10 minutes)', 'Mix ingredients (5 minutes)'];
